...
if($mybb->input['action'] == "thread")
{
	...
	// if ($mybb->user['uid'] != 0) {
	// 	$st_tid = $thread['tid'];
	// 	$st_subject = $thread['subject'];
	// 	$st_uid = $mybb->user['uid'];
	// 	$st_username = $mybb->user['username'];
	// 	$db->query("INSERT INTO `mybb_sg_sg_views` (`tid`, `uid`, `subject`, `username`) VALUES ('$st_tid','$st_uid','$st_subject','$st_username');");
	// }
	/* END CUSTOM CODE */
	...
	eval("\$showthread = \"".$templates->get("test_showthread")."\";");
