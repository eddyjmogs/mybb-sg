...
$my_stylesheets = "<link type=\"text/css\" rel=\"stylesheet\" href=\"/tests/css/global.min.css\" />\n";
$my_stylesheets .= "<link type=\"text/css\" rel=\"stylesheet\" href=\"/tests/css/sg_global.min.css\" />\n";
$my_stylesheets .= "<link type=\"text/css\" rel=\"stylesheet\" href=\"/tests/css/customSG.min.css\" />\n";

eval('$testheaderinclude = "'.$templates->get('test_headerinclude').'";');

eval('$headermenu = "'.$templates->get('test_header_menu').'";');
eval('$header = "'.$templates->get('test_header').'";');

eval('$index_section_1_inicial = "'.$templates->get('test_index_section_1_inicial').'";');
eval('$index_section_2_personajes = "'.$templates->get('test_index_section_2_personajes').'";');
eval('$index_section_3_mundo = "'.$templates->get('test_index_section_3_mundo').'";');
eval('$index_section_4_offrol = "'.$templates->get('test_index_section_4_offrol').'";');
eval('$index_section_5_final = "'.$templates->get('test_index_section_5_final').'";');
eval('$index_section_6_staff = "'.$templates->get('test_index_section_6_staff').'";');

eval('$index = "'.$templates->get('test_index').'";');
output_page($index);
