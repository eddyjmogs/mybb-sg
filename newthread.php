...
$month_input = $mybb->get_input('month_input');
...
$is_mundo_rol = false;
if (substr($forum['parentlist'], 0, 3) == '37,') {
	$is_mundo_rol = true;
}
...
if($mybb->input['action'] == "do_newthread" && $mybb->request_method == "post")
{
	...
	else
	{
		...
		$db->query(" 
			INSERT INTO `mybb_sg_sg_threads_cron` (`tid`, `year`, `month`, `day`) VALUES 
			('$tid', '$year_input', '$month_input', '$day_input');
		");
