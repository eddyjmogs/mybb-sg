...
!(function (o) {
    ...
    function Qe(e, t, n) {
        var o;
        we(window.CustomEvent) ? (o = new CustomEvent(t, { bubbles: !0, cancelable: !0, detail: n })) : (o = e.ownerDocument.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, n), e.dispatchEvent(o);
    }
    function Ge(e) {
    ...
    var n,
        ...
        pt =
            ...
            "contentEditable" in document.documentElement &&
                ...
                /Android/i.test(v) && ((m = !0), /Safari/.test(v) && (m = !(n = /Safari\/(\d+)/.exec(v)) || !n[1] || n[1] < 534)),
    ...
    var mt = {
            ...
            pastetext: {
                exec: function (e) {
                    var t,
                        n = De("div"),
                        o = this;
                    Re(n, ht("pastetext", { label: o._("Paste your text inside the following box:"), insert: o._("Insert") }, !0)),
            ...
            indent: {
                state: function (e, t) {
                    ...
                    return qe(t, "li")
                        ? 0
                        : qe(t, "ul,ol,menu") &&
                          ((o = (n = this.getRangeHelper().selectedRange()).startContainer.parentNode), (r = n.endContainer.parentNode), o !== o.parentNode.firstElementChild || (qe(r, "li") && r !== r.parentNode.lastElementChild))
                        ? 0
                        : -1;
                },
                exec: function () {
                ...
                exec: function (e) {
                    ...
                    Re(i, ht("table", { rows: r._("Rows:"), cols: r._("Cols:"), insert: r._("Insert") }, !0)),
                        Fe(i, "click", ".button", function (e) {
                            ...
                            0 < t &&
                                0 < n &&
                                ((o += Array(t + 1).join("<tr>" + Array(n + 1).join("<td>" + (x ? "" : "<br />") + "</td>") + "</tr>")), (o += "</table>"), r.wysiwygEditorInsertHtml(o), r.closeDropDown(!0), e.preventDefault());
                        }),
            ...
            image: {
                _dropDown: function (t, e, n, o) {
                    var r = De("div");
                    Re(r, ht("image", { url: t._("URL:"), width: t._("Width (optional):"), height: t._("Height (optional):"), insert: t._("Insert") }, !0));
                    var i = He(r, "#image")[0];
                    (i.value = n),
            ...
            email: {
                _dropDown: function (n, e, o) {
                    var r = De("div");
                    Re(r, ht("email", { label: n._("E-mail:"), desc: n._("Description (optional):"), insert: n._("Insert") }, !0)),
                        Fe(r, "click", ".button", function (e) {
                    ...
                    var p = this,
                        h = function (e) {
                            ...
                            return (
                                ...
                                Ee(d, function (e, t) {
                                    Re(u, De("img", { src: r + (t.url || t), alt: e, title: t.tooltip || e })), u.children.length >= n && ((u = De("div")), Re(c, u));
                                }),
                                !e &&
                                    o.emoticons.more &&
                                    (Re((t = De("a", { className: "sceditor-more" })), document.createTextNode(p._("More"))),
    ...
    var C = y && y < 11,
        E = function (e, t, n) {
            var o,
                ...
                c = e.startContainer,
                u = e.startOffset;
            for (c && 3 !== c.nodeType && ((c = c.childNodes[u]), (u = 0)), i = l = u; n > s.length && c && 3 === c.nodeType; )
                (o = c.nodeValue),
                    (r = n - s.length),
                    a && ((l = o.length), (i = 0)),
                    (a = c),
                    t ? ((u = i = Math.max(l - r, 0)), (s = o.substr(i, l - i) + s), (c = a.previousSibling)) : ((u = i + (l = Math.min(r, o.length))), (s += o.substr(i, l)), (c = a.nextSibling));
    ...
    function vt(i, e) {
        ...
        (y.insertHTML = function (e, t) {
            ...
            (l = function (e) {
                y.removeMarker(e);
                var t = De("span", { id: e, className: "sceditor-selection sceditor-ignore", style: "display:none;line-height:0" }, s);
            ...
            (y.replaceKeyword = function (e, t, n, o, r, i) {
                ...
                for (r && v++, i = i || "", u = (l = y.getOuterText(!0, v)).length, l += i, t && (l += y.getOuterText(!1, v)); m--; )
                    if (
                        ...
                        (c = Math.max(0, u - p - g)),
                        (s = -1),
                        r ? (a = l.substr(c).match(new RegExp(h + ct(f) + h))) && (s = a.index + c + a[1].length) : (s = l.indexOf(f, c)),
                        -1 < s && s <= u && u <= s + p + g)
                    )
                        return (d = u - s), y.selectOuterText(d, p - d - (/^\S/.test(i) ? 1 : 0)), y.insertHTML(e[m][1]), !0;
                return !1;
            }),
        ...
        (de.opts.emoticons = e.emoticons || st.emoticons),
            ...
            (H = function () {
                ...
                (e += ft ? " ios" : ""),
                    ...
                    d.write(ht("html", { attrs: ' class="' + e + '"', spellcheck: ye.spellcheck ? "" : 'spellcheck="false"', charset: ye.charset, style: ye.style })),
                    d.close(),
                    (h = d.body),
                    (i = s.contentWindow),
                        ...
                        (i = De("div", { className: "sceditor-group" })),
                            Ee(t.split(","), function (e, t) {
                                ...
                                !r ||
                                    -1 < a.indexOf(t) ||
                                    ((o = r.shortcut),
                                    (n = ht("toolbarButton", { name: t, dispName: de._(r.name || r.tooltip || t) }, !0).firstChild),
                                    ...
                                    r.state ? he.push({ name: t, state: r.state }) : be(r.exec) && he.push({ name: t, state: r.exec }),
                                    Re(i, n),
                                    (ge[t] = n));
                            }),
                            i.firstChild && Re(u, i);
            ...
            (_ = function () {
                ...
                Re(w, e),
                    ...
                    Fe(e, "touchstart mousedown", function (e) {
                        "touchstart" === e.type ? ((e = yt.event), (u = e.touches[0].pageX), (d = e.touches[0].pageY)) : ((u = e.pageX), (d = e.pageY)),
                            (h = Ke(w)),
                            (m = Xe(w)),
                            (y = !0),
                            $e(w, "resizing"),
            ...
            (L = function () {
                ...
                e && (ve = ke({}, e.more, e.dropdown, e.hidden)),
                    Ee(ve, function (e, t) {
                        (ve[e] = ht("emoticon", { key: e, url: n + (t.url || t), tooltip: t.tooltip || e })), ye.emoticonsEnabled && pe.push(De("img", { src: n + (t.url || t) }));
                    });
            }),
            (ne = function () {
                var e,
            ...
            (de.dimensions = function (e, t, n) {
                return (
                    (t = !(!t && 0 !== t) && t),
                    !1 === (e = !(!e && 0 !== e) && e) && !1 === t ? { width: de.width(), height: de.height() } : (!1 !== e && (!1 !== n && (ye.width = e), Ke(w, e)), !1 !== t && (!1 !== n && (ye.height = t), Xe(w, t)), de)
                );
            }),
            ...
            (de.maximize = function (e) {
                ...
                return xe(e)
                    ? We(w, t)
                    : ((e = !!e) && (S = yt.pageYOffset), Ye(bt.documentElement, t, e), Ye(bt.body, t, e), Ye(w, t, e), de.width(e ? "100%" : ye.width, !1), de.height(e ? "100%" : ye.height, !1), e || yt.scrollTo(0, S), ue(), de);
            }),
            (ue = function () {
            ...
            (de.createDropDown = function (e, t, n, o) {
                ...
                de.closeDropDown(!0),
                    (f && We(f, i)) ||
                        ...
                        (r = ke({ top: e.offsetTop, left: e.offsetLeft, marginTop: e.clientHeight }, ye.dropDownCss)),
            ...
            (de.sourceEditorCaret = function (e) {
                return c.focus(), e ? ((c.selectionStart = e.start), (c.selectionEnd = e.end), this) : { start: c.selectionStart, end: c.selectionEnd };
            }),
            (de.val = function (e, t) {
                return be(e)
                    ? (de.inSourceMode() ? de.setSourceEditorValue(e) : (!1 !== t && "toHtml" in l && (e = l.toHtml(e)), de.setWysiwygEditorValue(e)), de)
                    : de.inSourceMode()
            ...
            (B = function (e, t) {
                de.inSourceMode()
                    ? t.txtExec && (Array.isArray(t.txtExec) ? de.sourceEditorInsertText.apply(de, t.txtExec) : t.txtExec.call(de, e, J()))
                    : t.exec && (we(t.exec) ? t.exec.call(de, e) : de.execCommand(t.exec, t.hasOwnProperty("execParam") ? t.execParam : null));
            }),
            (R = function () {
            ...
            (de.focus = function (e, t, n) {
                if (we(e)) de.bind("focus", e, t, n);
                    ...
                    var o,
                        r = v.selectedRange();
                    x || ne(),
                        !wt && r && 1 === r.endOffset && r.collapsed && (o = r.endContainer) && 1 === o.childNodes.length && qe(o.firstChild, "br") && (r.setStartBefore(o.firstChild), r.collapse(!0), v.selectRange(r)),
                        i.focus(),
                        h.focus(),
                        ...
                        for (var r = 0; r < o.length; r++) {
                            ...
                            if ((a && n.test(a.nodeValue.slice(-1))) || (s && n.test((s.nodeValue || "")[0]))) {
                                ...
                                null === f && (f = a.innerText || ""),
                                    ...
                                    d === a && (u = c.startOffset),
                                    (s && s.nodeType === Te) || (s = l.insertBefore(l.ownerDocument.createTextNode(""), s)),
                                    s.insertData(0, f),
                                    Be(a),
                                    Be(i),
            ...
            (le = function (e) {
                if (r && (r.hasHandler("valuechangedEvent") || le.hasHandler)) {
                    ...
                    (e = (m = !1) !== e && !d.getElementById("sceditor-start-marker")),
                        ...
                        o && e && v.saveRange(),
                        (t = n ? c.value : h.innerHTML) !== le.lastVal && ((le.lastVal = t), Qe(w, "valuechanged", { rawValue: n ? de.val() : t })),
                        o && e && v.removeMarkers();
                }
            }),
            (ae = function () {
            ...
            (se = function (e) {
                ...
                (se.lastChar = t),
                    m ||
                        (13 === t || 32 === t ? (o ? (se.triggerNext = !0) : le()) : 8 === t || 46 === t ? (r ? (se.triggerNext = !0) : le()) : se.triggerNext && (le(), (se.triggerNext = !1)),
                        clearTimeout(g),
    ...
    (function (e) {
            ...
            w = {
                ...
                size: {
                    ...
                    format: function (e, t) {
                        ...
                        return (
                            n || (n = m(e, "fontSize")),
                            -1 < n.indexOf("px") ? ((n = n.replace("px", "") - 0) < 12 && (o = 1), 15 < n && (o = 3), 17 < n && (o = 4), 23 < n && (o = 5), 31 < n && (o = 6), 47 < n && (o = 7)) : (o = n),
                            "[size=" + o + "]" + t + "[/size]"
                        );
                    },
                ...
                img: {
                    ...
                    format: function (t, e) {
                        ...
                        return g(t, b)
                            ? e
                            : ((n = g(t, "width") || i("width")), (o = g(t, "height") || i("height")), ((t.complete && (n || o)) || (n && o)) && (r = "=" + h.width(t) + "x" + h.height(t)), "[img" + r + "]" + g(t, "src") + "[/img]");
                    },
                    html: function (e, t, n) {
                        var o,
                            r,
                        ...
                        return (
                            (o = t.width),
                            (r = t.height),
                            t.defaultattr && ((o = (i = t.defaultattr.split(/x/i))[0]), (r = 2 === i.length ? i[1] : i[0])),
                ...
                quote: {
                    ...
                    format: function (e, t) {
                        ...
                        return (
                            (n || g(e, o)) && ((r = (n && n.textContent) || g(e, o)), g(e, o, r), n && e.removeChild(n), (t = this.elementToBbcode(e)), (r = "=" + r.replace(/(^\s+|\s+$)/g, "")), n && e.insertBefore(n, e.firstChild)),
                            "[quote" + r + "]" + t + "[/quote]"
                        );
                    },
                    html: function (e, t, n) {
                ...
                left: { styles: { "text-align": ["left", "-webkit-left", "-moz-left", "-khtml-left"] }, isInline: !1, format: "[left]{0}[/left]", html: '<div align="left">{0}</div>' },
                center: { styles: { "text-align": ["center", "-webkit-center", "-moz-center", "-khtml-center"] }, isInline: !1, format: "[center]{0}[/center]", html: '<div align="center">{0}</div>' },
                right: { styles: { "text-align": ["right", "-webkit-right", "-moz-right", "-khtml-right"] }, isInline: !1, format: "[right]{0}[/right]", html: '<div align="right">{0}</div>' },
                justify: { styles: { "text-align": ["justify", "-webkit-justify", "-moz-justify", "-khtml-justify"] }, isInline: !1, format: "[justify]{0}[/justify]", html: '<div align="justify">{0}</div>' },
                youtube: {
                    allowsEmpty: !0,
                    ...
                    e === T &&
                        ...
                        n[2] &&
                            ...
                            (o = (function (e) {
                                ...
                                else for ("=" === e.charAt(0) && (e = "defaultattr" + e); (t = n.exec(e)); ) o[i(t[1])] = E(t[3]) || t[4];
                                return o;
                            })(n[2]))),
            ...
            (h.opts = n({}, B.defaults, e)),
                ...
                (h.parse = function (e, t) {
                    var n = (function (e) {
                            ...
                            for (; (t = e.shift()); )
                                switch (((l = e[0]), m(u(), t) || (t.type === N && u() && t.name === u().name) || ((t.name = "#"), (t.type = D)), t.type)) {
                                    case T:
                                    ...
                                    case M:
                                        u() &&
                                            l &&
                                            f((l.type === N ? "/" : "") + l.name) &&
                                            ((l.type === N && l.name === u().name) || ((n = w[u().name]) && n.breakAfter ? c.pop() : n && !1 === n.isInline && h.opts.breakAfterBlock && !1 !== n.breakAfter && c.pop())),
                                            d(t);
                                        break;
                                    default:
                                        d(t);
                                    ...
                                    if (r.type === M) {
                                        if (
                                            ...
                                            !o &&
                                                ...
                                                !0 !== a.isSelfClosing &&
                                                (i
                                                    ? c || l || (!1 === a.isInline && h.opts.breakEndBlock && !1 !== a.breakEnd && (d = !0), a.breakEnd && (d = !0), (c = d))
                                                    : (!1 === a.isInline && h.opts.breakStartBlock && !1 !== a.breakStart && (d = !0), a.breakStart && (d = !0))),
                                            i && i.type === T && (s = w[i.name]) && (o ? !1 === s.isInline && (d = !0) : (!1 === s.isInline && h.opts.breakAfterBlock && !1 !== s.breakAfter && (d = !0), s.breakAfter && (d = !0))),
                                            !o && !u && l && l.type === T && (s = w[l.name]) && (!1 === s.isInline && h.opts.breakBeforeBlock && !1 !== s.breakBefore && (d = !0), s.breakBefore && (d = !0), (u = d)))
                                        ) {
                                            t.splice(p, 1);
                                            continue;
                                        }
                            ...
                            if ((o = t.shift())) {
                                if (o.type === T)
                                    (u = o.children[o.children.length - 1] || {}),
                                        ...
                                        (i = e(o.children, !1)),
                                        r && r.html
                                            ? (c(r) || !c(w[u.name]) || r.isPreFormatted || r.skipLastLineBreak || y || (i += "<br />"), C(r.html) ? (l = r.html.call(h, o, o.attrs, i)) : ((o.attrs[0] = i), (l = k(r.html, o.attrs))))
                        ...
                        for (; 0 < t.length; )
                            if ((n = t.shift()))
                                if (
                                    ...
                                    (i = !(!r || !1 !== r.isInline)),
                                    (l = r && r.isSelfClosing),
                                    (s = (i && h.opts.breakBeforeBlock && !1 !== r.breakBefore) || (r && r.breakBefore)),
                                    (c = (i && !l && h.opts.breakStartBlock && !1 !== r.breakStart) || (r && r.breakStart)),
                                    ...
                                    if (n.type === T) {
                                        if ((s && f.push("\n"), f.push("[" + n.name), n.attrs))
                                            for (o in (n.attrs.defaultattr && (f.push("=", g(n.attrs.defaultattr, a, "defaultattr")), delete n.attrs.defaultattr), n.attrs))
            ...
            function t(e, t, n, o) {
                ...
                for (
                    a.innerHTML = t,
                        ...
                        e && (l.insertBefore(n.createTextNode("#"), l.firstChild), l.appendChild(n.createTextNode("#"))),
        ...
        (c.prototype = {
            ...
            (B.QuoteType = x),
            (B.defaults = { breakBeforeBlock: !1, breakStartBlock: !1, breakEndBlock: !1, breakAfterBlock: !0, removeEmptyTags: !0, fixInvalidNesting: !0, fixInvalidChildren: !0, quoteType: x.auto }),
            (d.get = function (e) {
                return w[e] || null;
            }),
            (d.set = function (e, t) {
